...
UFATrack is a professional Ultimate Frisbee dataset released with synchronized **video, tracking, and event annotations** to support reproducible research and practitioner use. :contentReference[oaicite:0]{index=0}

### Source / Scope
- Match: **Oakland Spiders vs Salt Lake Shred** (score: OAK 4–9 SLC)
- Date: **June 27, 2025**
- Segment: **2nd quarter** :contentReference[oaicite:1]{index=1}
- Effective play included: **~9.5 minutes** (excluding pulls and offense–defense transitions) :contentReference[oaicite:2]{index=2}
- Possessions: **20 possession sequences** :contentReference[oaicite:3]{index=3}

### Sampling & Coordinates
- Coordinate system: metric (x, y) on a standard pitch of **109.73 m × 48.77 m** :contentReference[oaicite:4]{index=4}
- Per frame: positions of **all 14 on-field players + the disc** :contentReference[oaicite:5]{index=5}
- Video: **30 fps**, tracking: **10 fps** :contentReference[oaicite:6]{index=6}

### Disc position definition
- Disc position is obtained by annotating the **disc holder**
- When no player is in possession, disc location is **linearly interpolated** between consecutive possession events :contentReference[oaicite:7]{index=7}
